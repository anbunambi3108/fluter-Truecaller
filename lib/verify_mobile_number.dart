        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton(
                onPressed: () async {
                  if (otpRequired) {
                    await truecaller.verifyOtp( _firstName.text, _lastName.text, _otp.text);
                  } else {
            ...
            StreamBuilder<TruecallerProfile>(
              ...
              builder: (context, snasphot) => Text(snasphot.hasData ? snasphot.data.firstName + " " + snasphot.data.lastName : " "),
            ),
          ],
        ),
      ),
